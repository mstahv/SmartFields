...
public class TCollectionSelect<T> extends CustomField<Collection<T>> {
	...
	public TCollectionSelect() {
		...
		select.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(
				...
				TCollectionSelect.super.setInternalValue(collection);
				fireValueChange(true);
			}
		});
	}

	public TCollectionSelect(Collection<T> options) {
		this();
		setOptions(options);
	}
	public TCollectionSelect(String caption, Collection<T> options) {
		this(caption);
		setOptions(options);
	}

	public TCollectionSelect(String caption) {
		this();
		setCaption(caption);
	}
